<template>
  <div class="App">
    <div class="App-errored" v-if="$store.state.kuzzle.errorFromKuzzle">
      <error-layout>
        <kuzzle-error-page
    ...
    <div v-else>
      <div class="App-noEnvironments" v-if="!$store.getters.hasEnvironment">
      ...
      <div v-else>
        ...
        <div class="App-connected" v-else>
          <div class="App-loggedOut" v-if="!$store.getters.isAuthenticated">
            <div class="App-noAdmin" v-if="!$store.getters.adminAlreadyExists">
              <sign-up
                @environment::create="editEnvironment"
                @environment::delete="deleteEnvironment"
              >
