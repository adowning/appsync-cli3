          ...
          <v-layout row justify-center>
            <v-flex xl4 lg4 md4 sm4 class="hidden-xs-only">
              <v-card class="elevation-0 mr-2 transparent">
                ...
                <div class="body-1">
                  Manage your basic information: your name, email, and phone
                  number, etc. Help others find you and make it easier to get in
                  touch.
                </div>
            ...
            <v-flex xl8 lg8 md8 sm8>
              <v-card class="mb-2">
                ...
                />
                <v-divider />
                <app-user-email :email="userModel.emailAddress" />
                <v-divider />
                <app-birth-date
